 <aside 
        ...
        class="bg-white shadow-lg transition-all duration-300 min-h-screen p-4 flex flex-col"
    >
        ...
        <div class="flex items-center gap-3 mb-6" :class="open ? 'justify-start' : 'justify-center'">
         ...
         alt="Admin"
         class="brand-image-logo me-2 shadow"
         >
            </div>
 ...
 <!-- Toggle Button -->
        <button @click="open = !open" 
            class="mb-4 px-2 py-1 bg-gray-200 rounded hover:bg-gray-300 focus:outline-none self-end">
    ...
    <a href="{{ route('admin.dashboard') }}" 
       class="block px-3 py-2 rounded hover:bg-gray-100 {{ request()->routeIs('admin.dashboard') ? 'bg-gray-100 font-medium' : '' }}">
        <span x-show="true">Dashboard</span>
    </a>
    ...
    <div>
        <button @click="openArticles = !openArticles" 
            ...
            <span>Articles</span>
            <svg x-show="!openArticles" class="w-4 h-4 transform rotate-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
            </svg>
            <svg x-show="openArticles" class="w-4 h-4 transform rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
            </svg>
        </button>

        <!-- Submenu -->
        <ul x-show="openArticles" x-transition class="pl-4 mt-1 space-y-1">
            <li>
